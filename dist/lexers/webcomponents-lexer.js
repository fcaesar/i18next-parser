...
WebComponentsLexer = function (_BaseLexer) {_inherits(WebComponentsLexer, _BaseLexer);
  function WebComponentsLexer() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};_classCallCheck(this, WebComponentsLexer);var _this = _possibleConstructorReturn(this, (WebComponentsLexer.__proto__ || Object.getPrototypeOf(WebComponentsLexer)).call(this,
    options));

    _this.attr = options.attr || 'data-i18n';
    _this.optionAttr = options.optionAttr || 'data-i18n-options';return _this;
  }_createClass(WebComponentsLexer, [{ key: 'extract', value: function extract(
    ...
    content) {var _this2 = this;
      ...
      return this.keys;
    } }]);return WebComponentsLexer;}(_baseLexer2.default);exports.default = WebComponentsLexer;module.exports = exports['default'];